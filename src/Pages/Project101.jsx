    ...
    <div className="gaming-background">
      <Container className="content-container" style={{ marginBottom: "20px" }}>
        ...
        <p className="gaming-text">
          ...
          a difference in the world? If so, you should join PiP 1o1, a project
          development program based on project-based learning.
        </p>
        <Row className="content-row">
          <Col xs={12} md={6} className="text-center">
            <img className="project-image" src={pip} alt="PiP" />
          </Col>
          <Col xs={12} md={6}>
            <h3 className="gaming-subheading">Description:</h3>
            <p className="gaming-text">
              In PiP 1o1, you will have the opportunity to choose from a range
              of exciting project themes, including AI for accessibility, IoT
              for sustainability, environment conservation, and more. You will
              work in teams to develop your own project, using the latest
              ...
              life. In addition to the project development phase, our PiP 1o1
              also includes research work and patent support. Our dedicated team
              with research experience will help you to undertake research
        ...
        <div className="additional-info">
          ...
          <div className="gaming-textOne row">
            ...
            >
              {" "}
              <a
                href="https://forms.office.com/pages/responsepage.aspx?id=o835AF4H5USqC6ujrdZTnzqAsQRWelxHktGudCoGdcVURUpPTEEyTFEwR1kxVk81MDIzSkZDR0ZCRi4u&route=shorturl"
                target="main"
              >
                <button
